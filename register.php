...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($password !== $repeat_password) {
        ...
        if ($conn->query($sql) === TRUE) {
            ...
            echo "<p class='bg-danger text-light d-flex justify-content-center p-2'>FORM TIDAK SESUAI!!</p>";
        }
    }
}
                        ...
                        <div class="p-5">
                            ...
                            <form class="user" method="POST" action="">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="password" name="repeat_password" class="form-control form-control-user" id="exampleRepeatPassword"
